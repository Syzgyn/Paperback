                ...
                upgradeAllowed.value &&
                  <FormGroup>
                    ...
                    <FormInputGroup
                      ...
                      values={languages}
                      helpText="Once this language is reached Paperback will no longer download issues"
      ...
      <ModalFooter>
        {
          id &&
            <div
              ...
              title={isInUse && 'Can\'t delete a language profile that is attached to a comic'}
            >
              <Button
                kind={kinds.DANGER}
                isDisabled={isInUse}
