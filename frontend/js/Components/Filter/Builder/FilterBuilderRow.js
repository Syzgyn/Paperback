...
import ComicStatusFilterBuilderRowValue from './ComicStatusFilterBuilderRowValue';
import ComicTypeFilterBuilderRowValue from './ComicTypeFilterBuilderRowValue';
...
function getRowValueConnector(selectedFilterBuilderProp) {
  ...
  switch (valueType) {
    ...
    case filterBuilderValueTypes.COMIC_STATUS:
      return ComicStatusFilterBuilderRowValue;

    case filterBuilderValueTypes.COMIC_TYPES:
      return ComicTypeFilterBuilderRowValue;
