...
class Measure extends Component {
  ...
  componentDidUpdate({config, whitelist, blacklist}) {
    ...
    if (this.props.whitelist !== whitelist ||
      ...
      this._propsToMeasure = this._getPropsToMeasure({ whitelist: this.props.whitelist, blacklist: this.props.blacklist })
    }
  }
