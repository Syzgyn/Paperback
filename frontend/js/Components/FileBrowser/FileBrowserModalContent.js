        ...
        >
          {
            isWindowsService &&
              <Alert
                ...
                kind={kinds.WARNING}
              >
                Mapped network drives are not available when running as a Windows Service, see the <Link className={styles.faqLink} to="https://wiki.servarr.com/Paperback_FAQ#Why_cant_Paperback_see_my_files_on_a_remote_server">FAQ</Link> for more information.
              </Alert>
          }
