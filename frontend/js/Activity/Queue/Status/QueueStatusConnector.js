...
function createMapStateToProps() {
  return createSelector(
    ...
    (state) => state.queue.options.includeUnknownComicItems,
    (app, status, includeUnknownComicItems) => {
      const {
        errors,
        warnings,
        unknownErrors,
      ...
      return {
        ...
        ...status.item,
        count: includeUnknownComicItems ? totalCount : count,
        errors: includeUnknownComicItems ? errors || unknownErrors : errors,
        warnings: includeUnknownComicItems ? warnings || unknownWarnings : warnings
      };
    }
  );
}
