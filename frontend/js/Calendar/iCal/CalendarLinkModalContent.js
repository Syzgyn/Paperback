...
function getUrls(state) {
  ...
  let icalUrl = `${window.location.host}${window.Paperback.urlBase}/feed/calendar/Paperback.ics?`;
  ...
  icalUrl += `apikey=${window.Paperback.apiKey}`;
          ...
          <Form>
            <FormGroup>
              ...
              <FormInputGroup
                ...
                name="unmonitored"
                value={unmonitored}
                helpText="Include unmonitored issues in the iCal feed"
            ...
            <FormGroup>
              ...
              <FormInputGroup
                ...
                name="premieresOnly"
                value={premieresOnly}
                helpText="Only the first issue in a season will be in the feed"
                onChange={this.onInputChange}
              />
            </FormGroup>
            ...
            <FormGroup>
              ...
              <FormInputGroup
                ...
                name="tags"
                value={tags}
                helpText="Feed will only contain comic with at least one matching tag"
                onChange={this.onInputChange}
              />
            </FormGroup>
