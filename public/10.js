...
/* harmony import */ var _Store_Slices_Settings_downloaders__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/Store/Slices/Settings/downloaders */ "./resources/js/Store/Slices/Settings/downloaders.js");
...
var ConnectorAddModalContent = function ConnectorAddModalContent(props) {
  ...
  var _useSelector = Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["useSelector"])(connected_react_router__WEBPACK_IMPORTED_MODULE_5__["getLocation"]),
      pathname = _useSelector.pathname;

  var fetchSchema, selector;

  if (pathname === "/settings/indexers") {
    fetchSchema = _Store_Slices_Settings_indexers__WEBPACK_IMPORTED_MODULE_6__["fetchSchema"];
    selector = _Store_Slices_Settings_indexers__WEBPACK_IMPORTED_MODULE_6__["settingsIndexersSelector"];
  } else {
    fetchSchema = _Store_Slices_Settings_downloaders__WEBPACK_IMPORTED_MODULE_7__["fetchSchema"];
    selector = _Store_Slices_Settings_downloaders__WEBPACK_IMPORTED_MODULE_7__["settingsDownloadersSelector"];
  }

  var _useSelector2 = Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["useSelector"])(selector),
      isSchemaLoading = _useSelector2.isSchemaLoading,
      isSchemaPopulated = _useSelector2.isSchemaPopulated,
      schema = _useSelector2.schema;
...
/* harmony import */ var _Store_Slices_Settings_downloaders__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/Store/Slices/Settings/downloaders */ "./resources/js/Store/Slices/Settings/downloaders.js");
...
var ConnectorAddModalItem = function ConnectorAddModalItem(props) {
  ...
  var _useSelector = Object(react_redux__WEBPACK_IMPORTED_MODULE_3__["useSelector"])(connected_react_router__WEBPACK_IMPORTED_MODULE_6__["getLocation"]),
      pathname = _useSelector.pathname;

  var selectSchema;

  if (pathname === "/settings/indexers") {
    selectSchema = _Store_Slices_Settings_indexers__WEBPACK_IMPORTED_MODULE_4__["selectSchema"];
  } else {
    selectSchema = _Store_Slices_Settings_downloaders__WEBPACK_IMPORTED_MODULE_5__["selectSchema"];
  }
...
/* harmony import */ var _Store_Slices_Settings_downloaders__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/Store/Slices/Settings/downloaders */ "./resources/js/Store/Slices/Settings/downloaders.js");
...
/* harmony import */ var _Store_Slices_Settings_indexers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/Store/Slices/Settings/indexers */ "./resources/js/Store/Slices/Settings/indexers.js");
/* harmony import */ var _Store_Slices_Settings_downloaders__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/Store/Slices/Settings/downloaders */ "./resources/js/Store/Slices/Settings/downloaders.js");
/* harmony import */ var _Components_Loading_LoadingIndicator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @/Components/Loading/LoadingIndicator */ "./resources/js/Components/Loading/LoadingIndicator.js");
...
var ConnectorEditModalContent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.forwardRef(function (props, formRef) {
  ...
  var _useSelector2 = Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["useSelector"])(selector),
      allSchema = _useSelector2.schema,
  ...
  if (!schema) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Components_Loading_LoadingIndicator__WEBPACK_IMPORTED_MODULE_8__["default"], null);
  }
