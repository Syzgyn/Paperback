        ...
        return (
            <PageRow className="settings-connector-list">
                {this.state.items.map(item => 
                    <ConnectorItem key={item.id} item={item} refreshCallback={this.getItems} url={this.props.url} />
                )}
                    <ConnectorEmptyItem refreshCallback={this.getItems} url={this.props.url}/> 
            </PageRow>
        );
    }
}
