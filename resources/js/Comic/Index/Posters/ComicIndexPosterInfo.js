...
import styles from './ComicIndexPosterInfo.module.scss';

function ComicIndexPosterInfo(props) {
  const {
    network,
    qualityProfile,
    showQualityProfile,
...
ComicIndexPosterInfo.propTypes = {
...
export default ComicIndexPosterInfo;
