...
import ComicIndexPoster from './ComicIndexPoster';
import styles from './ComicIndexPosters.module.scss';
...
class ComicIndexPosters extends Component {
  ...
  cellRenderer({ key, rowIndex, columnIndex, style }) {
    ...
    const comic = items[rowIndex * columnCount + columnIndex];
...
export default ComicIndexPosters;
