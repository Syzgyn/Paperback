...
import styles from './TagsModalContent.module.scss';
          ...
          <Form>
            ...
            <FormGroup>
              ...
              <FormInputGroup
                ...
                helpTexts={[
                  'How to apply tags to the selected comic',
...
TagsModalContent.propTypes = {
  comicTags: PropTypes.arrayOf(PropTypes.number).isRequired,
